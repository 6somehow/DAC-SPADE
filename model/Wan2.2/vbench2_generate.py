...
def generate(args):
    ...
    if args.vbench_root:
        ...
        dimension_list = [
            ...
            'Motion_Order_Understanding', 'Human_Interaction',
            'Complex_Landscape', 'Motion_Rationality', 'Instance_Preservation',
            'Mechanics', 'Thermotics', 'Material', 'Multi-View_Consistency'
        ]
